...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary mt-4 px-0 px-md-5 mb-5" style="width: 80%; margin: 0 auto;">
      <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
          <h4 class="text-white mb-4 mt-2">Kids Learning Center</h4>
          ...
          <a href="" class="btn btn-secondary mt-1 py-3 px-5 mb-2">Learn More</a>
        </div>
        <div class="col-lg-6 text-center text-lg-right">
          <img class="img-fluid mt-3"  src="{{ asset('front/img/header.png') }}" style="width:400px; height:300px;" alt="" />
        </div>
      </div>
    </div>
    <!-- Header End -->
